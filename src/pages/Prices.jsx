...
function Prices() {
  ...
  return (
    <section className="prices pt-[80px] bg-[Url(../assets/pricesbg.jpg)]">
      <div className="container h-full px-5">
      <p className="w-[160px]  text-[#8432e8] py-2 mt-[50px] mb-[50px]  text-center mx-auto rounded-4xl border border-[#8432e8]">{t("header.prices")}</p>
        <h2 className="pb-[40px] text-center text-[#FFF] text-4xl max-[440px]:text-2xl font-bold">{t("pri.title")}</h2>
        {/* ---------LANDING PAGE---------- */}
        <div className="page group bg-cover bg-center w-full h-full rounded-[10px] border border-[#928e8e] 
          ...
          <div className="w-[420px] max-[440px]:w-full  h-full p-[30px] md:border-r md:border-[#928e8e] group-hover:border-[#8432e8] max-[768]:bg-[#121212] rounded-l-[10px]">
            <h3 className="text-2xl max-[440px]:text-xl text-[#8432e8] font-bold pb-5">{t("pri.page.title")}</h3>
            <p className="w-[90%] text-md text-[#928e8e]">{t("pri.page.description")}</p>
          </div>
          <ul className="p-[30px]">
        ...
        <div className="page group bg-cover bg-center w-full h-full rounded-[10px] border border-[#928e8e]
         hover:border-[#8432e8] md:flex items-center justify-between mb-[5px]"
          >
          <div className="w-[420px] max-[440px]:w-full  h-full p-[30px] md:border-r md:border-[#928e8e] group-hover:border-[#8432e8] max-[768]:bg-[#121212] rounded-l-[10px]">
            <h3 className="text-2xl max-[440px]:text-xl text-[#8432e8] font-bold pb-5">{t("pri.card.title")}</h3>
            <p className="w-[90%] text-md text-[#928e8e]">{t("pri.card.description")}</p>
          </div>
          <ul className="p-[30px]">
            <li className="flex items-center gap-[8px]">
            <GiCheckMark className="text-[#8432e8]" />
        ...
        <div className="page group bg-cover bg-center w-full h-full rounded-[10px] border border-[#928e8e] 
          ...
          >
          <div className="w-[420px] max-[440px]:w-full  h-full p-[30px] md:border-r md:border-[#928e8e] group-hover:border-[#8432e8] max-[768]:bg-[#121212] rounded-l-[10px]">
            <h3 className="text-2xl max-[440px]:text-xl text-[#8432e8] font-bold pb-5">{t("pri.exc.title")}</h3>
            <p className="w-[90%] text-md text-[#928e8e]">{t("pri.exc.description")}</p>
          </div>
          <ul className="p-[30px]">
            <li className="flex items-center gap-[8px]">
            <GiCheckMark className="text-[#8432e8]" />
